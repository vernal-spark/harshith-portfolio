    ...
    <AnimatePresence mode="wait">
      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          ...
          >
            <span className="block sm:hidden">
              <Image src={navItem.icon} alt="nav" width={20} height={20} />
            </span>
        ...
        <Link
          ...
          target="_blank"
          className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-xl"
        >
          <span className="block sm:hidden">
            <Image
